                                ...
                                <div className="flex-auto p-4">
                                  <div className="flex flex-wrap -mx-3">
                                    ...
                                    <div className="w-4/12 max-w-full px-3 text-right flex-0">
                                      <div className="inline-flex cursor-pointer w-12 h-12 text-center text-white items-center justify-center rounded-lg bg-gradient-to-tl from-primary-shade-700 to-primary-shade-500 shadow-soft-2xl">
                                        <svg
